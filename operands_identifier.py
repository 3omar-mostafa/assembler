...
from instructions_identifier import variables_table
...
addressing_modes = {
    ...
    "relative_indirect": {"regex": fr"@{A}", "size": 1, "code": "111"}  # @X(PC)
}
...
def handle_instruction(program_counter: int, instruction_opcode: str, operand1: str, operand2: str):
    ...
    if operand1 is not None:
        ...
        if addressing_modes[addressing_mode].get('size') == 1:
            ...
            next_word = get_proper_next_word(program_counter, addressing_mode, value)
